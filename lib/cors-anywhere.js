...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    if (corsAnywhere.originWhitelist.length && corsAnywhere.originWhitelist.indexOf(origin) === -1) {
      res.writeHead(403, 'Forbidden', cors_headers);
      res.end('whitelist: ' + corsAnywhere.originWhitelist + '\n' + corsAnywhere.originWhitelist.length + '\n' + corsAnywhere.originWhitelist.indexOf(origin) + '\nThe origin "' + origin + '" was not whitelisted by the operator of this proxy.');
      return;
    }
